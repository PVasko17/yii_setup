...
/**
 * This is the model class for table "accountMarketers".
 *
 * The followings are the available columns in table 'accountMarketers':
 * @property integer $id
 * @property string $email
 * @property string $password
 */
class AccountAdmin extends CActiveRecord
{
    public $confirmEmail;
     ...
     * @return AccountMarketers the static model class
     */
    ...
    public function authenticate($attribute,$params)
    {
        if(!$this->hasErrors())
        {
            $this->_identity=new MarketerIdentity($this->email,$this->password);
    ...
    public function login()
    {
        ...
        if($this->_identity->errorCode===MarketerIdentity::ERROR_NONE)
        {
