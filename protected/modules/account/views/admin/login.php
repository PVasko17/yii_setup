...
<!--            Please sign in-->
    ...
    <a href="<?php echo Yii::app()->createUrl("account/marketer/resetPassword");?>">Reset marketer password</a>
    <label class="text-danger"><?php echo $error; ?></label>
        <button class="btn btn-lg btn-primary btn-block" type="submit">Login</button>
    <br/><br/><a href="<?php echo Yii::app()->createUrl("account/marketer/register");?>"><strong>Register as Marketer</strong></a>
    <?php $this->endWidget(); ?>
