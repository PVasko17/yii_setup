...
class Feeds extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('idpref, creatorid', 'numerical', 'integerOnly'=>true),
			array('type, date_creation', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, idpref, type, creatorid, date_creation', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('idpref',$this->idpref);
